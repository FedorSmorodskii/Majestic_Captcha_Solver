...
---
## Предупреждение:
Данный проект предназначен исключительно для образовательных и исследовательских целей. Он призван продемонстрировать уязвимости в системах CAPTCHA и подчеркнуть важность надежной защиты от ботов. Авторы не несут ответственности за любое неправомерное использование данного кода.
...
✅ Вы можете использовать, изучать и изменять код  
✅ Вы можете делиться им с другими  
✅ Вы можете адаптировать его под свои нужды  
❌ Запрещено коммерческое использование без разрешения  
❌ Если вы изменяете и делитесь им, вы должны использовать ту же лицензию  
❌ Вы должны указывать авторство  
См. файл [LICENSE](https://github.com/FedorSmorodskii/Majestic_Captcha_Solver/blob/master/LICENSE.txt) для полного юридического текста.
